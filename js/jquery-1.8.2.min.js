...
(((a, b) => {
  ...
  p.fn=p.prototype={constructor:p,init(a, c, d) {
  ...
  },noop() {},globalEval(b) {b&&r.test(b)&&(a.execScript||(b => {a.eval.call(a,b)}))(b)},camelCase(a) {return a.replace(A,"ms-").replace(B,C)},nodeName(a, b) {return a.nodeName&&a.nodeName.toLowerCase()===b.toLowerCase()},each(a, c, d) {
    var e;
    var f=0;
    var g=a.length;
  ...
  },trim:o&&!o.call("﻿ ")?a => a==null?"":o.call(a):a => a==null?"":(a+"").replace(t,""),makeArray(a, b) {
    var c;
    var d=b||[];
    ...
    var e;
    var f;
    return typeof c=="string"&&(d=a[c],c=a,a=d),p.isFunction(a)?(e=k.call(arguments,2),f=function(...args) {return a.apply(c,e.concat(k.call(args)));},f.guid=a.guid=a.guid||p.guid++,f):b;
  ...
  p.extend({cache:{},deletedIds:[],uuid:0,expando:"jQuery"+(p.fn.jquery+Math.random()).replace(/\D/g,""),noData:{embed:!0,object:"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000",applet:!0},hasData(a) {return a=a.nodeType?p.cache[a[p.expando]]:a[p.expando],!!a&&!K(a)},data(a, c, d, e) {
    ...
    var k=j?p.cache:a;
    var l=j?a[h]:a[h]&&h;
    if((!l||!k[l]||!e&&!k[l].data)&&i&&d===b)return;l||(j?a[h]=l=p.deletedIds.pop()||p.guid++:l=h),k[l]||(k[l]={},j||(k[l].toJSON=p.noop));if(typeof c=="object"||typeof c=="function")e?k[l]=p.extend(k[l],c):k[l].data=p.extend(k[l].data,c);return f=k[l],e||(f.data||(f.data={}),f=f.data),d!==b&&(f[p.camelCase(c)]=d),i?(g=f[c],g==null&&(g=f[p.camelCase(c)])):g=f,g
  },removeData(a, b, c) {
    if(!p.acceptData(a))return;
    var d;
    var e;
  ...
  p.event={add(a, c, d, e, f) {
    ...
    function bc(a,b,c,d){
    ...
    }function bd(a){return b => {var c=b.nodeName.toLowerCase();return c==="input"&&b.type===a};}function be(a){return b => {var c=b.nodeName.toLowerCase();return(c==="input"||c==="button")&&b.type===a};}function bf(a){return z(b => (b=+b, z((c, d) => {
      var e;
      var f=a([],c.length,b);
      var g=f.length;
      while(g--)c[e=f[g]]&&(c[e]=!(d[e]=c[e]))
    })));}function bg(a,b,c){if(a===b)return c;var d=a.nextSibling;while(d){if(d===b)return-1;d=d.nextSibling}return 1}function bh(a,b){
      var c;
      var d;
      var f;
      var g;
      ...
      var e=b.dir;
      var f=d&&b.dir==="parentNode";
      var g=u++;
      return b.first?(b, c, d) => {while(b=b[e])if(f||b.nodeType===1)return a(b,c,d)}:(b, d, h) => {if(!h){
        var i;
        var j=t+" "+g+" ";
        var k=j+c;
        while(b=b[e])if(f||b.nodeType===1){if((i=b[o])===k)return b.sizset;if(typeof i=="string"&&i.indexOf(j)===0){if(b.sizset)return b}else{b[o]=k;if(a(b,d,h))return b.sizset=!0,b;b.sizset=!1}}
      }else while(b=b[e])if(f||b.nodeType===1)if(a(b,d,h))return b};
    }function bj(a){return a.length>1?(b, c, d) => {var e=a.length;while(e--)if(!a[e](b,c,d))return!1;return!0}:a[0];}function bk(a,b,c,d,e){
      var f;
      var g=[];
      var h=0;
      var i=a.length;
    ...
    }function bl(a,b,c,d,e,f){return d&&!d[o]&&(d=bl(d)),e&&!e[o]&&(e=bl(e,f)),z((f, g, h, i) => {
      if(f&&e)return;
      var j;
      var k;
      var l;
      ...
      var n=[];
      var o=g.length;
      var p=f||bo(b||"*",h.nodeType?[h]:h,[],f);
      var q=a&&(f||!b)?bk(p,m,a,h,i):p;
      var r=c?e||(f?a:o||d)?[]:g:q;
      c&&c(q,r,h,i);if(d){l=bk(r,n),d(l,[],h,i),j=l.length;while(j--)if(k=l[j])r[n[j]]=!(q[n[j]]=k)}if(f){j=a&&r.length;while(j--)if(k=r[j])f[m[j]]=!(g[m[j]]=k)}else r=bk(r===g?r.splice(o,r.length):r),e?e(null,g,r,i):w.apply(g,r)
    });}function bm(a){
      var b;
      var c;
      var d;
      var f=a.length;
      var g=e.relative[a[0].type];
      var h=g||e.relative[" "];
      var i=g?1:0;
      var j=bi(a => a===b,h,!0);
      var k=bi(a => y.call(b,a)>-1,h,!0);
      var m=[(a, c, d) => !g&&(d||c!==l)||((b=c).nodeType?j(a,c,d):k(a,c,d))];
      for(;i<f;i++)if(c=e.relative[a[i].type])m=[bi(bj(m),c)];else{c=e.filter[a[i].type].apply(null,a[i].matches);if(c[o]){d=++i;for(;d<f;d++)if(e.relative[a[d].type])break;return bl(i>1&&bj(m),i>1&&a.slice(0,i-1).join("").replace(L,"$1"),c,i<d&&bm(a.slice(i,d)),d<f&&bm(a=a.slice(d)),d<f&&a.join(""))}m.push(c)}return bj(m)
    }function bn(a,b){
      var d=b.length>0;
      var f=a.length>0;
      var g=(h, i, j, k, m) => {var n,o,p,q=[],s=0,u="0",x=h&&[],y=m!=null,z=l,A=h||f&&e.find.TAG("*",m&&i.parentNode||i),B=t+=z==null?1:Math.E;y&&(l=i!==r&&i,c=g.el);for(;(n=A[u])!=null;u++){if(f&&n){for(o=0;p=a[o];o++)if(p(n,i,j)){k.push(n);break}y&&(t=B,c=++g.el)}d&&((n=!p&&n)&&s--,h&&x.push(n))}s+=u;if(d&&u!==s){for(o=0;p=b[o];o++)p(x,q,i,j);if(h){if(s>0)while(u--)!x[u]&&!q[u]&&(q[u]=v.call(k));q=bk(q)}w.apply(k,q),y&&!h&&q.length>0&&s+b.length>1&&bc.uniqueSort(k)}return y&&(t=B,l=z),x};
      return g.el=0,d?z(g):g
    }function bo(a,b,c,d){
      var e=0;
      var f=b.length;
      for(;e<f;e++)bc(a,b[e],c,d);return c
    ...
    var w=[].push;
    var x=[].slice;
    var y=[].indexOf||function(a){var b=0,c=this.length;for(;b<c;b++)if(this[b]===a)return b;return-1};
    var z=(a, b) => (a[o]=b==null||b, a);
    var A=() => {var a={},b=[];return z((c, d) => (b.push(c)>e.cacheLength&&delete a[b.shift()], a[c]=d),a);};
    var B=A();
    var C=A();
    var D=A();
    var E="[\\x20\\t\\r\\n\\f]";
    ...
    var G=F.replace("w","w#");
    var H="([*^$|!~]?=)";
    var I="\\["+E+"*("+F+")"+E+"*(?:"+H+E+"*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|("+G+")|)|)"+E+"*\\]";
    var J=":("+F+")(?:\\((?:(['\"])((?:\\\\.|[^\\\\])*?)\\2|([^()[\\]]*|(?:(?:"+I+")|[^:]|\\\\.)*|.*))\\)|)";
    var K=":(even|odd|eq|gt|lt|nth|first|last)(?:\\("+E+"*((?:-\\d)?\\d*)"+E+"*\\)|)(?=[^-]|$)";
    var L=new RegExp("^"+E+"+|((?:^|[^\\\\])(?:\\\\.)*)"+E+"+$","g");
    var M=new RegExp("^"+E+"*,"+E+"*");
    var N=new RegExp("^"+E+"*([\\x20\\t\\r\\n\\f>+~])"+E+"*");
    var O=new RegExp(J);
    var P=/^(?:#([\w\-]+)|(\w+)|\.([\w\-]+))$/;
    var Q=/^:not/;
    var R=/[\x20\t\r\n\f]*[+~]/;
    ...
    var V=/\\(?!\\)/g;
    var W={ID:new RegExp("^#("+F+")"),CLASS:new RegExp("^\\.("+F+")"),NAME:new RegExp("^\\[name=['\"]?("+F+")['\"]?\\]"),TAG:new RegExp("^("+F.replace("w","w*")+")"),ATTR:new RegExp("^"+I),PSEUDO:new RegExp("^"+J),POS:new RegExp(K,"i"),CHILD:new RegExp("^:(only|nth|first|last)-child(?:\\("+E+"*(even|odd|(([+-]|)(\\d*)n|)"+E+"*(?:([+-]|)"+E+"*(\\d+)|))"+E+"*\\)|)","i"),needsContext:new RegExp("^"+E+"*[>+~]|"+K,"i")};
    var X=a => {var b=r.createElement("div");try{return a(b)}catch(c){return!1}finally{b=null}};
    var Y=X(a => (a.appendChild(r.createComment("")), !a.getElementsByTagName("*").length));
    var Z=X(a => (a.innerHTML="<a href='#'></a>", a.firstChild&&typeof a.firstChild.getAttribute!==n&&a.firstChild.getAttribute("href")==="#"));
    var $=X(a => {a.innerHTML="<select></select>";var b=typeof a.lastChild.getAttribute("multiple");return b!=="boolean"&&b!=="string"});
    var _=X(a => (a.innerHTML="<div class='hidden e'></div><div class='hidden'></div>", !a.getElementsByClassName||!a.getElementsByClassName("e").length?!1:(a.lastChild.className="e",a.getElementsByClassName("e").length===2)));
    var ba=X(a => {a.id=o+0,a.innerHTML="<a name='"+o+"'></a><div name='"+o+"'></div>",s.insertBefore(a,s.firstChild);var b=r.getElementsByName&&r.getElementsByName(o).length===2+r.getElementsByName(o+0).length;return d=!r.getElementById(o),s.removeChild(a),b});
    try{x.call(s.childNodes,0)[0].nodeType}catch(bb){x=function(a){
      var b;
      var c=[];
      for(;b=this[a];a++)c.push(b);return c
    }}bc.matches=(a, b) => bc(a,null,null,b),bc.matchesSelector=(a, b) => bc(b,null,null,[a]).length>0,f=bc.getText=a => {
      var b;
      var c="";
      var d=0;
      var e=a.nodeType;
      if(e){if(e===1||e===9||e===11){if(typeof a.textContent=="string")return a.textContent;for(a=a.firstChild;a;a=a.nextSibling)c+=f(a)}else if(e===3||e===4)return a.nodeValue}else for(;b=a[d];d++)c+=f(b);return c
    },g=bc.isXML=a => {var b=a&&(a.ownerDocument||a).documentElement;return b?b.nodeName!=="HTML":!1},h=bc.contains=s.contains?(a, b) => {
      var c=a.nodeType===9?a.documentElement:a;
      var d=b&&b.parentNode;
      return a===d||!!(d&&d.nodeType===1&&c.contains&&c.contains(d))
    }:s.compareDocumentPosition?(a, b) => b&&!!(a.compareDocumentPosition(b)&16):(a, b) => {while(b=b.parentNode)if(b===a)return!0;return!1},bc.attr=(a, b) => {
      var c;
      var d=g(a);
      return d||(b=b.toLowerCase()),(c=e.attrHandle[b])?c(a):d||$?a.getAttribute(b):(c=a.getAttributeNode(b),c?typeof a[b]=="boolean"?a[b]?b:null:c.specified?c.value:null:null)
    },e=bc.selectors={cacheLength:50,createPseudo:z,match:W,attrHandle:Z?{}:{href(a) {return a.getAttribute("href",2)},type(a) {return a.getAttribute("type")}},find:{ID:d?(a, b, c) => {if(typeof b.getElementById!==n&&!c){var d=b.getElementById(a);return d&&d.parentNode?[d]:[]}}:(a, c, d) => {if(typeof c.getElementById!==n&&!d){var e=c.getElementById(a);return e?e.id===a||typeof e.getAttributeNode!==n&&e.getAttributeNode("id").value===a?[e]:b:[]}},TAG:Y?(a, b) => {if(typeof b.getElementsByTagName!==n)return b.getElementsByTagName(a)}:(a, b) => {var c=b.getElementsByTagName(a);if(a==="*"){
      var d;
      var e=[];
      var f=0;
      for(;d=c[f];f++)d.nodeType===1&&e.push(d);return e
    }return c},NAME:ba&&((a, b) => {if(typeof b.getElementsByName!==n)return b.getElementsByName(name)}),CLASS:_&&((a, b, c) => {if(typeof b.getElementsByClassName!==n&&!c)return b.getElementsByClassName(a)})},relative:{">":{dir:"parentNode",first:!0}," ":{dir:"parentNode"},"+":{dir:"previousSibling",first:!0},"~":{dir:"previousSibling"}},preFilter:{ATTR(a) {return a[1]=a[1].replace(V,""),a[3]=(a[4]||a[5]||"").replace(V,""),a[2]==="~="&&(a[3]=" "+a[3]+" "),a.slice(0,4)},CHILD(a) {return a[1]=a[1].toLowerCase(),a[1]==="nth"?(a[2]||bc.error(a[0]),a[3]=+(a[3]?a[4]+(a[5]||1):2*(a[2]==="even"||a[2]==="odd")),a[4]=+(a[6]+a[7]||a[2]==="odd")):a[2]&&bc.error(a[0]),a},PSEUDO(a) {
      var b;
      var c;
      if(W.CHILD.test(a[0]))return null;if(a[3])a[2]=a[3];else if(b=a[4])O.test(b)&&(c=bh(b,!0))&&(c=b.indexOf(")",b.length-c)-b.length)&&(b=b.slice(0,c),a[0]=a[0].slice(0,c)),a[2]=b;return a.slice(0,3)
    }},filter:{ID:d?a => (a=a.replace(V,""), b => b.getAttribute("id")===a):a => (a=a.replace(V,""), b => {var c=typeof b.getAttributeNode!==n&&b.getAttributeNode("id");return c&&c.value===a}),TAG(a) {return a==="*"?() => !0:(a=a.replace(V,"").toLowerCase(),b => b.nodeName&&b.nodeName.toLowerCase()===a);},CLASS(a) {var b=B[o][a];return b||(b=B(a,new RegExp("(^|"+E+")"+a+"("+E+"|$)"))),a => b.test(a.className||typeof a.getAttribute!==n&&a.getAttribute("class")||"");},ATTR(a, b, c) {return (d, e) => {var f=bc.attr(d,a);return f==null?b==="!=":b?(f+="",b==="="?f===c:b==="!="?f!==c:b==="^="?c&&f.indexOf(c)===0:b==="*="?c&&f.indexOf(c)>-1:b==="$="?c&&f.substr(f.length-c.length)===c:b==="~="?(" "+f+" ").indexOf(c)>-1:b==="|="?f===c||f.substr(0,c.length+1)===c+"-":!1):!0};},CHILD(a, b, c, d) {return a==="nth"?a => {
      var b;
      var e;
      var f=a.parentNode;
      if(c===1&&d===0)return!0;if(f){e=0;for(b=f.firstChild;b;b=b.nextSibling)if(b.nodeType===1){e++;if(a===b)break}}return e-=d,e===c||e%c===0&&e/c>=0
    }:b => {var c=b;switch(a){case"only":case"first":while(c=c.previousSibling)if(c.nodeType===1)return!1;if(a==="first")return!0;c=b;case"last":while(c=c.nextSibling)if(c.nodeType===1)return!1;return!0}};},PSEUDO(a, b) {
      var c;
      var d=e.pseudos[a]||e.setFilters[a.toLowerCase()]||bc.error("unsupported pseudo: "+a);
      return d[o]?d(b):d.length>1?(c=[a,a,"",b],e.setFilters.hasOwnProperty(a.toLowerCase())?z((a, c) => {
        var e;
        var f=d(a,b);
        var g=f.length;
      ...
      var b=[];
      var c=[];
      var d=i(a.replace(L,"$1"));
      return d[o]?z((a, b, c, e) => {
        var f;
        var g=d(a,null,e,[]);
        var h=a.length;
        while(h--)if(f=g[h])a[h]=!(b[h]=f)
      }):(a, e, f) => (b[0]=a, d(b,null,f,c), !c.pop());
    }),has:z(a => b => bc(a,b).length>0),contains:z(a => b => (b.textContent||b.innerText||f(b)).indexOf(a)>-1),enabled(a) {return a.disabled===!1},disabled(a) {return a.disabled===!0},checked(a) {var b=a.nodeName.toLowerCase();return b==="input"&&!!a.checked||b==="option"&&!!a.selected},selected(a) {return a.parentNode&&a.parentNode.selectedIndex,a.selected===!0},parent(a) {return!e.pseudos.empty(a)},empty(a) {var b;a=a.firstChild;while(a){if(a.nodeName>"@"||(b=a.nodeType)===3||b===4)return!1;a=a.nextSibling}return!0},header(a) {return T.test(a.nodeName)},text(a) {
      var b;
      var c;
      return a.nodeName.toLowerCase()==="input"&&(b=a.type)==="text"&&((c=a.getAttribute("type"))==null||c.toLowerCase()===b)
    },radio:bd("radio"),checkbox:bd("checkbox"),file:bd("file"),password:bd("password"),image:bd("image"),submit:be("submit"),reset:be("reset"),button(a) {var b=a.nodeName.toLowerCase();return b==="input"&&a.type==="button"||b==="button"},input(a) {return U.test(a.nodeName)},focus(a) {var b=a.ownerDocument;return a===b.activeElement&&(!b.hasFocus||b.hasFocus())&&(!!a.type||!!a.href)},active(a) {return a===a.ownerDocument.activeElement},first:bf((a, b, c) => [0]),last:bf((a, b, c) => [b-1]),eq:bf((a, b, c) => [c<0?c+b:c]),even:bf((a, b, c) => {for(var d=0;d<b;d+=2)a.push(d);return a}),odd:bf((a, b, c) => {for(var d=1;d<b;d+=2)a.push(d);return a}),lt:bf((a, b, c) => {for(var d=c<0?c+b:c;--d>=0;)a.push(d);return a}),gt:bf((a, b, c) => {for(var d=c<0?c+b:c;++d<b;)a.push(d);return a})}},j=s.compareDocumentPosition?(a, b) => a===b?(k=!0,0):(!a.compareDocumentPosition||!b.compareDocumentPosition?a.compareDocumentPosition:a.compareDocumentPosition(b)&4)?-1:1:(a, b) => {
      ...
      var h=b.parentNode;
      var i=g;
      if(g===h)return bg(a,b);if(!g)return-1;if(!h)return 1;while(i)e.unshift(i),i=i.parentNode;i=h;while(i)f.unshift(i),i=i.parentNode;c=e.length,d=f.length;for(var j=0;j<c&&j<d;j++)if(e[j]!==f[j])return bg(e[j],f[j]);return j===c?bg(a,f[j],-1):bg(e[j],b,1)
    },[0,0].sort(j),m=!k,bc.uniqueSort=a => {
      var b;
      var c=1;
      k=m,a.sort(j);if(k)for(;b=a[c];c++)b===a[c-1]&&a.splice(c--,1);return a
    },bc.error=a => {throw new Error("Syntax error, unrecognized expression: "+a)},i=bc.compile=(a, b) => {
      var c;
      var d=[];
      var e=[];
      var f=D[o][a];
      if(!f){b||(b=bh(a)),c=b.length;while(c--)f=bm(b[c]),f[o]?d.push(f):e.push(f);f=D(a,bn(e,d))}return f
    },r.querySelectorAll&&(() => {
      var a;
      var b=bp;
      var c=/'|\\/g;
      ...
      var e=[":focus"];
      var f=[":active",":focus"];
      var h=s.matchesSelector||s.mozMatchesSelector||s.webkitMatchesSelector||s.oMatchesSelector||s.msMatchesSelector;
      X(a => {a.innerHTML="<select><option selected=''></option></select>",a.querySelectorAll("[selected]").length||e.push("\\["+E+"*(?:checked|disabled|ismap|multiple|readonly|selected|value)"),a.querySelectorAll(":checked").length||e.push(":checked")}),X(a => {a.innerHTML="<p test=''></p>",a.querySelectorAll("[test^='']").length&&e.push("[*^$]="+E+"*(?:\"\"|'')"),a.innerHTML="<input type='hidden'/>",a.querySelectorAll(":enabled").length||e.push(":enabled",":disabled")}),e=new RegExp(e.join("|")),bp=(a, d, f, g, h) => {if(!g&&!h&&(!e||!e.test(a))){
        var i;
        var j;
        var k=!0;
        var l=o;
        var m=d;
        var n=d.nodeType===9&&a;
        if(d.nodeType===1&&d.nodeName.toLowerCase()!=="object"){i=bh(a),(k=d.getAttribute("id"))?l=k.replace(c,"\\$&"):d.setAttribute("id",l),l="[id='"+l+"'] ",j=i.length;while(j--)i[j]=l+i[j].join("");m=R.test(a)&&d.parentNode||d,n=i.join(",")}if(n)try{return w.apply(f,x.call(m.querySelectorAll(n),0)),f}catch(p){}finally{k||d.removeAttribute("id")}
      }return b(a,d,f,g,h)},h&&(X(b => {a=h.call(b,"div");try{h.call(b,"[test!='']:sizzle"),f.push("!=",J)}catch(c){}}),f=new RegExp(f.join("|")),bc.matchesSelector=(b, c) => {c=c.replace(d,"='$1']");if(!g(b)&&!f.test(c)&&(!e||!e.test(c)))try{var i=h.call(b,c);if(i||a||b.document&&b.document.nodeType!==11)return i}catch(j){}return bc(c,null,null,[b]).length>0})
  ...
  try{ck=f.href}catch(cy){ck=e.createElement("a"),ck.href="",ck=ck.href}cj=ct.exec(ck.toLowerCase())||[],p.fn.load=function(a,c,d){
  ...
  },p.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),(a, b) => {p.fn[b]=function(a){return this.on(b,a)}}),p.each(["get","post"],(a, c) => {p[c]=(a, d, e, f) => (p.isFunction(d)&&(f=f||e,e=d,d=b), p.ajax({type:c,url:a,data:d,success:e,dataType:f}))}),p.extend({getScript(a, c) {return p.get(a,b,c,"script")},getJSON(a, b, c) {return p.get(a,b,c,"json")},ajaxSetup(a, b) {return b?cB(a,p.ajaxSettings):(b=a,a=p.ajaxSettings),cB(a,b),a},ajaxSettings:{url:ck,isLocal:cn.test(cj[1]),global:!0,type:"GET",contentType:"application/x-www-form-urlencoded; charset=UTF-8",processData:!0,async:!0,accepts:{xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript","*":cx},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":a.String,"text html":!0,"text json":p.parseJSON,"text xml":p.parseXML},flatOptions:{context:!0,url:!0}},ajaxPrefilter:cz(cv),ajaxTransport:cz(cw),ajax(a, c) {
    function y(a,c,f,i){
      var k;
      var s;
      var t;
    ...
    o.promise(x),x.success=x.done,x.error=x.fail,x.complete=q.add,x.statusCode=function(a){if(a){var b;if(v<2)for(b in a)r[b]=[r[b],a[b]];else b=a[x.status],x.always(b)}return this},l.url=((a||l.url)+"").replace(cl,"").replace(cp,cj[1]+"//"),l.dataTypes=p.trim(l.dataType||"*").toLowerCase().split(s),l.crossDomain==null&&(i=ct.exec(l.url.toLowerCase())||!1,l.crossDomain=i&&i.join(":")+(i[3]?"":i[1]==="http:"?80:443)!==cj.join(":")+(cj[3]?"":cj[1]==="http:"?80:443)),l.data&&l.processData&&typeof l.data!="string"&&(l.data=p.param(l.data,l.traditional)),cA(cv,l,c,x);if(v===2)return x;j=l.global,l.type=l.type.toUpperCase(),l.hasContent=!co.test(l.type),j&&p.active++===0&&p.event.trigger("ajaxStart");if(!l.hasContent){l.data&&(l.url+=(cq.test(l.url)?"&":"?")+l.data,delete l.data),d=l.url;if(l.cache===!1){
      var z=p.now();
  ...
  var cR=/queueHooks$/;
  var cS=[cY];
  var cT={"*":[function(a,b){var c,d,e=this.createTween(a,b),f=cQ.exec(b),g=e.cur(),h=+g||0,i=1,j=20;if(f){c=+f[2],d=f[3]||(p.cssNumber[a]?"":"px");if(d!=="px"&&h){h=p.css(e.elem,a,!0)||c||1;do i=i||".5",h=h/i,p.style(e.elem,a,h+d);while(i!==(i=e.cur()/g)&&i!==1&&--j)}e.unit=d,e.start=h,e.end=f[1]?h+(f[1]+1)*c:c}return e}]};
